...
public class Int101Homework01 {
   ...
   public static void work03UseOfUtilityClass() {
      ...
      */
      double bmi = MyUtil.calculateBMI(70, 1.85);
      double average = MyUtil.average(70, 50, 100);
   ...
   public static void work04UseOfObjectClass() {
       Person one = new Person();
       Person two = new Person();
       one.Personid(4);
       two.Personid(5);
       BankAccount a = new BankAccount(3,one,9000);
       System.out.println("BankAccount1: "+a);
       BankAccount b = new BankAccount(4,two,7000);
       System.out.println("BankAccount2: "+b);
       a.deposit(10000);
       a.withdraw(500);
       a.transfer(1000, b);
       System.out.println("BankAccount1 final balance: "+a);
       System.out.println("BankAccount2 final balance: "+b);
